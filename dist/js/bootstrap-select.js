...
(function ($) {
  ...
  $.expr.pseudos.icontains = function (obj, index, meta) {
    var words = meta[3].toUpperCase().split(" ");
    var my_exp = '';
    words.forEach(function (entry) {
        var current = String.fromCharCode(40, 63, 61, 46, 42) + entry + String.fromCharCode(41);
        my_exp += current;
    });
    my_exp += String.fromCharCode(46, 43);
    var $obj = $(obj);
    var haystack = ($obj.data('tokens') || $obj.text()).toString().toUpperCase();
    //return haystack.includes(meta[3].toUpperCase());
    return haystack.match(my_exp);
  };
